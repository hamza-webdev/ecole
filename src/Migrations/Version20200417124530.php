 ...
 */
final class Version20200417124530 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adresse DROP INDEX IDX_C35F08168127E502, ADD UNIQUE INDEX UNIQ_C35F08168127E502 (adresse_p1_id)');
        ...
        $this->addSql('DROP INDEX UNIQ_41E6F90DA76ED395 ON parent_pere_mere');
        $this->addSql('DROP INDEX UNIQ_41E6F90D93924AEC ON parent_pere_mere');
        $this->addSql('ALTER TABLE parent_pere_mere DROP user_id, DROP adresse_p2_id, CHANGE sexe_p1_id sexe_p1_id INT DEFAULT NULL, CHANGE civilite_id civilite_id INT DEFAULT NULL, CHANGE sexe_p2_id sexe_p2_id INT DEFAULT NULL, CHANGE civilite_p2_id civilite_p2_id INT DEFAULT NULL, CHANGE situation_familiale_id situation_familiale_id INT DEFAULT NULL, CHANGE prenom_p1 prenom_p1 VARCHAR(255) DEFAULT NULL, CHANGE email_p1 email_p1 VARCHAR(255) DEFAULT NULL, CHANGE telephone_p1 telephone_p1 VARCHAR(20) DEFAULT NULL, CHANGE name_p2 name_p2 VARCHAR(255) DEFAULT NULL, CHANGE prenom_p2 prenom_p2 VARCHAR(255) DEFAULT NULL, CHANGE email_p2 email_p2 VARCHAR(255) DEFAULT NULL, CHANGE telephone_p2 telephone_p2 VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adresse DROP INDEX UNIQ_C35F08168127E502, ADD INDEX IDX_C35F08168127E502 (adresse_p1_id)');
        $this->addSql('ALTER TABLE adresse CHANGE adresse_p1_id adresse_p1_id INT DEFAULT NULL, CHANGE numero numero INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_41E6F90DA76ED395 ON parent_pere_mere (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_41E6F90D93924AEC ON parent_pere_mere (adresse_p2_id)');
