 ...
 */
final class Version20200413194415 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE eleve CHANGE sexe_id sexe_id INT DEFAULT NULL, CHANGE parent_p1_p2_id parent_p1_p2_id INT DEFAULT NULL, CHANGE classeroom_id classeroom_id INT DEFAULT NULL, CHANGE prenom prenom VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE telephone telephone VARCHAR(20) DEFAULT NULL');
        $this->addSql('ALTER TABLE examin ADD title VARCHAR(255) DEFAULT NULL, CHANGE matiere_cour_id matiere_cour_id INT DEFAULT NULL, CHANGE proffesseur_id proffesseur_id INT DEFAULT NULL, CHANGE type_examin_id type_examin_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE examin DROP title, CHANGE matiere_cour_id matiere_cour_id INT DEFAULT NULL, CHANGE proffesseur_id proffesseur_id INT DEFAULT NULL, CHANGE type_examin_id type_examin_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE matiere CHANGE coefficient coefficient DOUBLE PRECISION DEFAULT \'NULL\'');
